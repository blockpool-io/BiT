...
router.post('/', (req, res) => {
  ...
  let occupationperiod  = req.body.occupationperiod;
  let disabled = req.body.disabled;
  if (!ticker || !locationlabel || !rewardingbitid || !rewardingwalletid || !amount || !latitude || !longitude || !proximity || !occupationperiod || disabled === undefined) {
